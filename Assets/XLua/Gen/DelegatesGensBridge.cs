...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp5(UnityEngine.Vector3 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new DG.Tweening.Core.DOGetter<UnityEngine.Vector3>(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(DG.Tweening.Core.DOSetter<UnityEngine.Vector3>))
			{
			    return new DG.Tweening.Core.DOSetter<UnityEngine.Vector3>(__Gen_Delegate_Imp5);
			}

...
namespace UnityEditor
{
    public static class EditorReflectionUtilly
    {
        ...
        /// <returns></returns>
        public static bool IsArray<T>(this T instance, int rank)
        {
        ...
        /// <param name="rank">Array中的维数</param>
        /// <returns></returns>
        public static bool IsArray(this Type type, int rank)
        {
        ...
        /// 指示instance是否是数组
        /// </summary>
        public static bool IsArray<T>(this T instance)
        {
        ...
        {
            return Attribute.GetCustomAttributes(type, attributeType, false).Length > 0;
        }
        #endregion
        ...
        /// 要排除的Assembly
        /// </summary>
        static List<string> s_AssemblyExclusion = new List<string>() {
                    "Unity.Locator",
        ...
        public static Assembly[] GetCustomAssemblies()
        {
            ...
            return (type.GetProperty("loadedAssemblies", BindingFlags.Static | BindingFlags.NonPublic).GetValue(null, null) as Assembly[]).Where(a => !s_AssemblyExclusion.Contains(a.FullName.Substring(0, a.FullName.IndexOf(',')))).ToArray();
        }
